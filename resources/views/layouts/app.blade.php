            ...
            $('#TablaAsistencias').DataTable({  
                ...
                buttons: [{
                    ...
                    doc.content.splice( 1, 0, {
                        ...
                        alignment: 'center',
                        <?php
                        $im = file_get_contents('http://datatables.net/media/images/logo-fade.png');
                        $imdata = base64_encode($im);
                        ?>
                        image: 'data:image/png;base64,{{$imdata}}',
                        fit: [100, 100]
                    } );
                }
                },
                ...
                },
                {
                    ...
                    customize: function ( win ) {
                        $(win.document.body)
                            .css( 'font-size', '10pt' )
                            .prepend(
                                '<img src="http://datatables.net/media/images/logo-fade.png" width="150px" />'
                            );
